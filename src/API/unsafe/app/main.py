...
async def read_root(request: Request):
    ...
    return {"detail": "Hello, welcome to the Unsafe API! GDC research project by Ian-Chains Baute.", "type": "unsafe", "client_host": request.client.host}
...
async def logout(request: Request, response: Response):
    ...
    try:
        response.delete_cookie(key=settings.COOKIE_KEY, domain=settings.COOKIE_DOMAIN)
    except Exception:
