 ...
 *
 * Opmerking:
 * - deze unsafe variant stuurt geen CSRF-header mee
 */
async function create_post(event) {
    ...
    try {
        // Stap 3: stuur URL-encoded formulierdata naar de API.
        // Let op: in deze unsafe variant ontbreekt een CSRF-header.
        ...
        // Stap 4: verwerk API-resultaat en toon gebruikersfeedback.
